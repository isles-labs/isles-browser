    ...
    resources: {
      en: {
        translation: {
          ...
          window_clear_cache: 'Clear cache',
          window_clear_cache_title: 'Clear Cache',
          window_clear_cache_confirm:
            'This will delete the local cache for the selected closed window(s). Running windows will be skipped.',
          window_clear_cache_success: 'Cache cleared successfully',
          window_clear_cache_failed: 'Failed to clear cache',
          window_clear_cache_partial:
            'Cleared {{cleared}} window cache(s), skipped {{skipped}} window(s).',
          window_select_first: 'Please select at least one window first',
          ...
          proxy_edit: 'Edit',
          proxy_delete: 'Delete',
          proxy_batch_update_type: 'Batch Update Type',
      ...
      zh: {
        translation: {
          ...
          window_edit: '编辑',
          window_delete: '删除',
          window_clear_cache: '清除缓存',
          window_clear_cache_title: '清除缓存',
          window_clear_cache_confirm: '将删除所选已关闭窗口的本地缓存，运行中的窗口会被跳过。',
          window_clear_cache_success: '缓存清除成功',
          window_clear_cache_failed: '缓存清除失败',
          window_clear_cache_partial: '已清除 {{cleared}} 个窗口缓存，跳过 {{skipped}} 个窗口。',
          window_select_first: '请先选择至少一个窗口',
          ...
          proxy_edit: '编辑',
          proxy_delete: '删除',
          proxy_batch_update_type: '批量修改类型',
