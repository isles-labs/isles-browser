...
const Api = () => {
  type ApiInfo = Awaited<ReturnType<typeof CommonBridge.getApi>>;
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Form.Item label="本地 API Token">
            <Text copyable>{apiInfo.token}</Text>
          </Form.Item>
        </Form>
        <Divider />
        ...
        <Paragraph
          code
          copyable={{text: `${apiInfo.url}/profiles/open`}}
        >
          POST /profiles/open {`{ "windowId": xxx }`}
        </Paragraph>
        <Paragraph>{t('api_closeProfile')}</Paragraph>
        <Paragraph
          code
          copyable={{text: `${apiInfo.url}/profiles/close`}}
        >
          POST /profiles/close {`{ "windowId": xxx }`}
        </Paragraph>
